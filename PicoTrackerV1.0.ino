 ...
 * Ensure the device is square and aligned with your vectors, X or FORWARDS has to point towards
 * your monitor and Z should be pointing DOWN
 * 
 * The device is sensitive to magnetic fields and metal, so make sure you calibrate
